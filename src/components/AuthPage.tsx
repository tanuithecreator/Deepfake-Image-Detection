...
export function AuthPage({ navigate, login, signup, googleSignIn, errorMessage, clearError }: AuthPageProps) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-lg">
          ...
          <CardContent>
            <Tabs defaultValue="login" className="w-full" onValueChange={(value: string) => setActiveTab(value as 'login' | 'signup')}>
